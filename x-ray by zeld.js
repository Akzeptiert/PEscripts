const Esp = new Module("X-ray by Zeld", true, true, ModuleCategory.MISC);

var blockIdSetting = new TextFieldSetting("Block ID", "Enter block ID", "129");
var radiusSetting = new TextFieldSetting("Radius", "Enter Radius", "50");
var enableRGB = new StateSetting("Enable RGB", false);
